...
__export(daily_esm_exports, {
  DAILY_ACCESS_LEVEL_FULL: () => Lr,
  DAILY_ACCESS_LEVEL_LOBBY: () => Ir,
  DAILY_ACCESS_LEVEL_NONE: () => Nr,
  DAILY_ACCESS_UNKNOWN: () => xr,
  ...
  DAILY_EVENT_ACCESS_STATE_UPDATED: () => yi,
  DAILY_EVENT_ACTIVE_SPEAKER_CHANGE: () => Gi,
  DAILY_EVENT_ACTIVE_SPEAKER_MODE_CHANGE: () => qi,
  DAILY_EVENT_APP_MSG: () => Ni,
  DAILY_EVENT_CAMERA_ERROR: () => ui,
  DAILY_EVENT_CPU_LOAD_CHANGE: () => Wi,
  DAILY_EVENT_ERROR: () => ao,
  DAILY_EVENT_EXIT_FULLSCREEN: () => Ki,
  DAILY_EVENT_FACE_COUNTS_UPDATED: () => Hi,
  ...
  DAILY_EVENT_LOCAL_SCREEN_SHARE_CANCELED: () => $i,
  DAILY_EVENT_LOCAL_SCREEN_SHARE_STARTED: () => Vi,
  DAILY_EVENT_LOCAL_SCREEN_SHARE_STOPPED: () => Ji,
  DAILY_EVENT_MEETING_SESSION_DATA_ERROR: () => wi,
  DAILY_EVENT_MEETING_SESSION_STATE_UPDATED: () => bi,
  DAILY_EVENT_MEETING_SESSION_SUMMARY_UPDATED: () => _i,
  DAILY_EVENT_NETWORK_CONNECTION: () => zi,
  DAILY_EVENT_NETWORK_QUALITY_CHANGE: () => Yi,
  DAILY_EVENT_NONFATAL_ERROR: () => oo,
  DAILY_EVENT_PARTICIPANT_COUNTS_UPDATED: () => mi,
  DAILY_EVENT_PARTICIPANT_JOINED: () => fi,
  ...
  DAILY_EVENT_RECORDING_STATS: () => ji,
  DAILY_EVENT_RECORDING_STOPPED: () => Di,
  DAILY_EVENT_RECORDING_UPLOAD_COMPLETED: () => Li,
  DAILY_EVENT_REMOTE_MEDIA_PLAYER_STARTED: () => Bi,
  DAILY_EVENT_REMOTE_MEDIA_PLAYER_STOPPED: () => Ui,
  DAILY_EVENT_REMOTE_MEDIA_PLAYER_UPDATED: () => Fi,
  DAILY_EVENT_STARTED_CAMERA: () => li,
  DAILY_EVENT_THEME_UPDATED: () => oi,
  DAILY_EVENT_TRACK_STARTED: () => Ci,
  DAILY_EVENT_TRACK_STOPPED: () => Mi,
  DAILY_EVENT_TRANSCRIPTION_ERROR: () => Pi,
  DAILY_EVENT_TRANSCRIPTION_MSG: () => Ri,
  DAILY_EVENT_TRANSCRIPTION_STARTED: () => Ti,
  DAILY_EVENT_TRANSCRIPTION_STOPPED: () => Oi,
  DAILY_EVENT_WAITING_PARTICIPANT_ADDED: () => Si,
  DAILY_EVENT_WAITING_PARTICIPANT_REMOVED: () => Ei,
  DAILY_EVENT_WAITING_PARTICIPANT_UPDATED: () => ki,
  DAILY_FATAL_ERROR_CONNECTION: () => Wr,
  DAILY_FATAL_ERROR_EJECTED: () => Fr,
  DAILY_FATAL_ERROR_EOL: () => Yr,
  DAILY_FATAL_ERROR_EXP_ROOM: () => Jr,
  DAILY_FATAL_ERROR_EXP_TOKEN: () => $r,
  DAILY_FATAL_ERROR_MEETING_FULL: () => qr,
  DAILY_FATAL_ERROR_NBF_ROOM: () => Ur,
  DAILY_FATAL_ERROR_NBF_TOKEN: () => Vr,
  DAILY_FATAL_ERROR_NOT_ALLOWED: () => zr,
  DAILY_FATAL_ERROR_NO_ROOM: () => Gr,
  DAILY_RECEIVE_SETTINGS_ALL_PARTICIPANTS_KEY: () => Br,
  DAILY_RECEIVE_SETTINGS_BASE_KEY: () => Rr,
  DAILY_STATE_ERROR: () => Mr,
  DAILY_STATE_JOINED: () => Er,
  DAILY_STATE_JOINING: () => kr,
  DAILY_STATE_LEFT: () => Cr,
  DAILY_STATE_NEW: () => br,
  DAILY_TRACK_STATE_BLOCKED: () => Tr,
  DAILY_TRACK_STATE_INTERRUPTED: () => Dr,
...
var v, m, y, _, b, w, k, x, N, R, B, F, U, V, J, $, G, q, Y, z, W, ee, be, ke, Ee, Te, Ae, De, Ie, qe, ze, Qe, Ke, Xe, Ze, et, at, st, ct, lt, dt, ht, St, Ct, Ot, Pt, At, Dt, jt, xt, Lt, Vt, Gt, Yt, Ht, Zt, en, tn, cn, dn, fn, gn, vn, _n, Sn, kn, En, Cn, Mn, Tn, Pn, An, Dn, Rn, Jn, $n, Gn, Hn, Qn, Xn, ir, or, ur, dr, hr, mr, yr, _r, br, wr, Sr, kr, Er, Cr, Mr, Tr, Or, Pr, Ar, Dr, jr, xr, Lr, Ir, Nr, Rr, Br, Fr, Ur, Vr, Jr, $r, Gr, qr, Yr, zr, Wr, Hr, Qr, Kr, Xr, Zr, ei, ti, ni, ri, ii, oi, ai, si, ci, li, ui, di, hi, pi, fi, gi, vi, mi, yi, _i, bi, wi, Si, ki, Ei, Ci, Mi, Ti, Oi, Pi, Ai, Di, ji, xi, Li, Ii, Ni, Ri, Bi, Fi, Ui, Vi, Ji, $i, Gi, qi, Yi, zi, Wi, Hi, Qi, Ki, Xi, Zi, eo, to, no, ro, io, oo, ao, so, co, lo, uo, ho, po, fo, go, vo, mo, yo, _o, bo, wo, So, Oo, Vo, qo, Wo, Ho, Qo, Ko, Xo, ra, ia, oa, aa, sa, ca, la, ua, da, ha, pa, fa, ga, Sa, ka, Ma, Ta, Oa, ja, La, Ia, Va, Ja, $a, Ga, qa, Ya, za, Wa, Ha, Qa, Ka, Xa, Za, es;
var init_daily_esm = __esm({
  "node_modules/@daily-co/daily-js/dist/daily-esm.js"() {
    ...
    q = [{ test: [/googlebot/i], describe: () => ({ type: "bot", vendor: "Google" }) }, { test: [/huawei/i], describe(e2) {
    ...
    Y = [{ test: (e2) => "microsoft edge" === e2.getBrowserName(true), describe(e2) {
    ...
    ke = we();
    Ee = 80;
    Te = ["debug", "info", "warn", "error", "log", "assert", "trace"];
    ...
    Dt = "undefined" != typeof __SENTRY_BROWSER_BUNDLE__ && __SENTRY_BROWSER_BUNDLE__ || "[object process]" !== Object.prototype.toString.call("undefined" != typeof process ? process : 0) ? function() {
    ...
    jt = void 0 === Dt ? At : { nowSeconds: () => (Dt.timeOrigin + Dt.now()) / 1e3 };
    xt = At.nowSeconds.bind(At);
    Lt = jt.nowSeconds.bind(jt);
    (() => {
      const { performance: e2 } = Pt;
      if (!e2 || !e2.now) return;
...
Reason: ${e3}`);
    ...
    Mn = [/^.*healthcheck.*$/, /^.*healthy.*$/, /^.*live.*$/, /^.*ready.*$/, /^.*heartbeat.*$/, /^.*\/health$/, /^.*\/healthz$/];
    Tn = class _Tn {
      static __initStatic() {
...
Url: ${On(e4)}`), true;
    ...
    Tn.__initStatic();
    Pn = Object.freeze({ __proto__: null, FunctionToString: En, InboundFilters: Tn });
    An = be;
    Dn = 0;
    ...
    hr.__initStatic();
    mr = Object.freeze({ __proto__: null, Breadcrumbs: Gn, Dedupe: hr, GlobalHandlers: Xn, HttpContext: dr, LinkedErrors: ur, TryCatch: or });
    yr = {};
    ...
    hi = "joined-meeting";
    pi = "left-meeting";
    fi = "participant-joined";
    gi = "participant-updated";
    vi = "participant-left";
    mi = "participant-counts-updated";
    yi = "access-state-updated";
    _i = "meeting-session-summary-updated";
    bi = "meeting-session-state-updated";
    wi = "meeting-session-data-error";
    Si = "waiting-participant-added";
    ki = "waiting-participant-updated";
    Ei = "waiting-participant-removed";
    Ci = "track-started";
    Mi = "track-stopped";
    Ti = "transcription-started";
    Oi = "transcription-stopped";
    Pi = "transcription-error";
    ...
    Ii = "recording-data";
    Ni = "app-message";
    Ri = "transcription-message";
    Bi = "remote-media-player-started";
    Fi = "remote-media-player-updated";
    Ui = "remote-media-player-stopped";
    Vi = "local-screen-share-started";
    Ji = "local-screen-share-stopped";
    $i = "local-screen-share-canceled";
    Gi = "active-speaker-change";
    qi = "active-speaker-mode-change";
    Yi = "network-quality-change";
    zi = "network-connection";
    Wi = "cpu-load-change";
    Hi = "face-counts-updated";
    Qi = "fullscreen";
    ...
    vo = { NONE: "none", NOISE_CANCELLATION: "noise-cancellation" };
    mo = { PLAY: "play", PAUSE: "pause" };
    yo = 10;
    _o = ["jpg", "png", "jpeg"];
    bo = "add-endpoints";
    wo = "remove-endpoints";
    So = "sip-call-transfer";
    Oo = function() {
      try {
    ...
    Ja = "video";
    $a = "voice";
    Ga = Eo() ? { data: {} } : { data: {}, topology: "none" };
    qa = { present: 0, hidden: 0 };
    Ya = { maxBitrate: { min: 1e5, max: 25e5 }, maxFramerate: { min: 1, max: 30 }, scaleResolutionDownBy: { min: 1, max: 8 } };
    za = Object.keys(Ya);
    Wa = ["state", "volume", "simulcastEncodings"];
    Ha = { androidInCallNotification: { title: "string", subtitle: "string", iconName: "string", disableForCustomOverride: "boolean" }, disableAutoDeviceManagement: { audio: "boolean", video: "boolean" } };
    Qa = { id: { iconPath: "string", iconPathDarkMode: "string", label: "string", tooltip: "string" } };
    Ka = { id: { allow: "string", controlledBy: "'*' | 'owners' | string[]", csp: "string", iconURL: "string", label: "string", loading: "'eager' | 'lazy'", location: "'main' | 'sidebar'", name: "string", referrerPolicy: "string", sandbox: "string", src: "string", srcdoc: "string", shared: "string[] | 'owners' | boolean" } };
    Xa = { customIntegrations: { validate: _s, help: ms() }, customTrayButtons: { validate: ys, help: "customTrayButtons should be a dictionary of the type ".concat(JSON.stringify(Qa)) }, url: { validate: function(e2) {
    ...
    Za = { styles: { validate: function(e2) {
          ...
          [ContentType.FormData]: (input) => Object.keys(input || {}).reduce((formData, key) => {
            ...
            if (Array.isArray(property)) {
              property.forEach((item) => {
                formData.append(key, item instanceof Blob || item instanceof File ? item : typeof item === "object" && item !== null ? JSON.stringify(item) : `${item}`);
              });
            } else {
              formData.append(key, property instanceof Blob || property instanceof File ? property : typeof property === "object" && property !== null ? JSON.stringify(property) : `${property}`);
            }
            return formData;
          }, new FormData()),
